...
// 4. Force installation of version 1.29.x with ALL dependencies forcefully downgraded (-W flag) to match exactly PHP 8.2!
$output = shell_exec('php composer.phar require phpoffice/phpspreadsheet:^1.29 -W 2>&1');
